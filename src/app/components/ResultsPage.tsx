...
export function ResultsPage() {
  ...
  useEffect(() => {
    document.title = `Compare Rides: ${pickup} → ${drop} | RideCompare`;
  }, [pickup, drop]);
  ...
  const filteredResults = useMemo(() => {
    ...
    results = results.filter(
      (r) => r.fare >= priceRange[0] && r.fare <= priceRange[1],
    );
    ...
    if (showSurgeOnly) {
      results = results.filter(
        (r) => r.surgeMultiplier && r.surgeMultiplier > 1,
      );
    }
  ...
  const resetAllFilters = () => {
    ...
    const fares = allResults.map((r) => r.fare);
    setPriceRange([
      Math.floor(Math.min(...fares) - 50),
      Math.ceil(Math.max(...fares) + 50),
    ]);
    setMinRating(0);
    setMaxETA(60);
  ...
  const surgeCount = filteredResults.filter(
    (r) => r.surgeMultiplier && r.surgeMultiplier > 1,
  ).length;
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-background to-muted/30 px-4">
        <div className="max-w-xl text-center">
          ...
          <p
            ...
            Please enter your pickup and destination to compare ride options.
          </p>
          <Link
            to="/"
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              ...
              <Navigation
                className={`w-4 h-4 ${locationDetecting ? "animate-spin" : ""}`}
              />
            ...
            <div className="relative group">
              ...
              <div className="relative flex items-center gap-3 px-5 py-3 bg-primary-foreground/10 backdrop-blur-sm rounded-xl border-2 border-accent/40">
                ...
                <span
                  ...
                  className="text-primary-foreground max-w-[200px] truncate">
                  {pickup}
                </span>
              </div>
            </div>
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            {surgeCount > 0 && (
              <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-destructive/20 border border-destructive/40 backdrop-blur-sm">
                ...
                <span
                  className="text-destructive uppercase tracking-wider"
                    ...
                    {providers.map((p) => (
                      <label
                        ...
                        <div className="relative flex-shrink-0">
                          <div
                            className="absolute inset-0 rounded-lg blur-sm opacity-0 group-hover/provider:opacity-50 transition-opacity"
                        ...
                        <span
                          ...
                          {
                            allResults.filter((r) => r.provider === p.name)
                              .length
                          }{" "}
                          rides
                        </span>
              ...
              <div className="relative group">
                ...
                <div className="relative bg-card rounded-2xl border-2 border-border/50 group-hover:border-accent/50 p-6 transition-all shadow-lg">
                  ...
                  <div
                    ...
                    <span>₹0</span>
                    <span>
                      ₹{Math.max(...allResults.map((r) => r.fare)) + 100}
                    </span>
                  </div>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <button
                        ...
                        {opt.label}
                        {sortBy === opt.value && (
                          <Sparkles className="w-4 h-4 ml-auto text-accent" />
                        )}
                      </button>
                    ))}
                  </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
                  {[
                    ...
                    <div key={i} className="relative group">
                      <div
                        className={`absolute inset-0 bg-gradient-to-br ${stat.gradient} rounded-xl blur-md opacity-50 group-hover:opacity-75 transition-opacity`}
                      />
                      <div
                        className={`relative px-5 py-5 rounded-xl border-2 border-accent/30 bg-gradient-to-br ${stat.gradient} text-white shadow-xl group-hover:scale-105 transition-transform`}>
