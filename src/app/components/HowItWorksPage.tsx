...
export function HowItWorksPage() {
  return (
    <div className="relative">
      {/* Hero Section */}
      <section className="relative py-28 sm:py-36 overflow-hidden bg-gradient-to-br from-primary via-[#2a2321] to-primary">
        {/* Animated Background */}
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-primary-foreground mb-8 leading-tight" style={{ fontSize: "clamp(2.5rem, 6vw, 4.5rem)", fontWeight: 900, letterSpacing: "-0.03em" }}>
            How RideCompare
            <br />
          ...
          <p className="text-primary-foreground/70 max-w-3xl mx-auto leading-relaxed" style={{ fontSize: "1.25rem", lineHeight: 1.8 }}>
            A sophisticated aggregation platform engineered with precision, built on official partnerships, and designed for the most discerning travelers.
          </p>
        </div>
      </section>
            ...
            {[
              {
                ...
                features: ["Smart autocomplete", "Geolocation precision", "Popular destinations"],
              ...
              },
              {
                ...
                features: ["Parallel processing", "Official APIs", "Real-time data"],
              ...
              },
              {
                ...
                features: ["Multi-factor analysis", "Transparent pricing", "Quality metrics"],
              ...
              },
              {
                ...
                features: ["Direct deep-linking", "Secure transfer", "Official booking"],
                gradient: "from-[#5a524d] to-[#3a342f]",
              },
            ].map((item, i) => (
              <div key={item.step} className="flex gap-10 lg:gap-16">
                {/* Timeline */}
                <div className="hidden sm:flex flex-col items-center">
                  <div className="relative group">
                    <div className={`absolute inset-0 bg-gradient-to-br ${item.gradient} rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity`} />
                    <div
                ...
                <div className="flex-1 pb-20">
                  ...
                  <h3 className="text-foreground mb-4" style={{ fontSize: "clamp(1.5rem, 3vw, 2rem)", fontWeight: 900, letterSpacing: "-0.01em" }}>
                    {item.title}
                  </h3>

                  <p className="text-muted-foreground mb-6 max-w-2xl leading-relaxed" style={{ fontSize: "1.05rem", lineHeight: 1.8 }}>
                    {item.desc}
                  </p>

                  <div className="flex flex-wrap gap-3">
                    {item.features.map((feature, fi) => (
                      <div key={fi} className="flex items-center gap-2 px-4 py-2 rounded-lg bg-card border-2 border-border/50 shadow-sm">
                        <CheckCircle2 className="w-4 h-4 text-accent flex-shrink-0" />
                        <span className="text-foreground" style={{ fontSize: "0.9rem", fontWeight: 600 }}>
                          {feature}
                        </span>
                      </div>
                    ))}
      ...
      {/* Trust & Compliance */}
      <section className="py-28 bg-card relative overflow-hidden border-y-4 border-accent/20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-3xl mx-auto leading-relaxed" style={{ fontSize: "1.15rem", lineHeight: 1.8 }}>
              Every aspect of our platform is engineered with transparency, privacy protection, and official authorization at its core.
            </p>
          </div>
          ...
          <div className="mb-16 relative group max-w-5xl mx-auto">
            ...
            <div className="relative rounded-3xl overflow-hidden border-4 border-accent/30 shadow-2xl">
              <img
                ...
                className="w-full h-[350px] sm:h-[500px] object-cover group-hover:scale-105 transition-transform duration-700"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-primary/95 via-primary/60 to-transparent" />
              <div className="absolute bottom-10 left-10 right-10 sm:left-16 sm:bottom-16 sm:right-16">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/90 backdrop-blur-sm mb-4">
                  <Award className="w-4 h-4 text-accent-foreground" />
                  <span className="text-accent-foreground uppercase tracking-wider" style={{ fontSize: "0.7rem", fontWeight: 700 }}>
                    Verified Partnerships
                  </span>
                </div>
                <h3 className="text-primary-foreground mb-3" style={{ fontSize: "clamp(1.5rem, 3vw, 2.5rem)", fontWeight: 900, letterSpacing: "-0.01em" }}>
                  Official API Agreements
                </h3>
                <p className="text-primary-foreground/80 max-w-2xl leading-relaxed" style={{ fontSize: "clamp(0.95rem, 2vw, 1.15rem)", lineHeight: 1.7 }}>
                  Working exclusively with authenticated provider APIs to guarantee authentic, real-time data and maintain the highest standards of trust.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="group relative">
                ...
                <div className="relative h-full bg-background rounded-2xl border-2 border-border/50 group-hover:border-accent/60 p-8 transition-all duration-300 shadow-lg group-hover:shadow-2xl group-hover:-translate-y-1">
                  <div className="relative mb-6">
                    <div className={`w-16 h-16 rounded-xl bg-gradient-to-br ${item.gradient} flex items-center justify-center text-white shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300`}>
                      {item.icon}
                    </div>
                    <div className={`absolute inset-0 w-16 h-16 rounded-xl bg-gradient-to-br ${item.gradient} blur-md opacity-50 group-hover:opacity-70 transition-opacity`} />
                  </div>
                  <h4 className="text-foreground mb-3" style={{ fontSize: "1.2rem", fontWeight: 800, letterSpacing: "-0.01em" }}>
                    {item.title}
                  </h4>
      ...
      <section className="py-28 bg-gradient-to-b from-background to-muted/30 relative overflow-hidden">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <div className="w-32 h-1.5 bg-gradient-to-r from-transparent via-accent to-transparent mx-auto rounded-full mb-6" />
            <p className="text-muted-foreground max-w-3xl mx-auto leading-relaxed" style={{ fontSize: "1.15rem", lineHeight: 1.8 }}>
              A carefully architected revenue model that preserves user experience while ensuring platform sustainability
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-8">
            {[
              ...
              <div key={i} className="group relative">
                <div className="absolute inset-0 bg-gradient-to-br from-accent/10 to-transparent rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <div className="relative flex items-start gap-6 p-8 bg-card rounded-2xl border-2 border-border/50 group-hover:border-accent/60 transition-all duration-300 shadow-lg group-hover:shadow-2xl">
                  <div className="relative flex-shrink-0">
                    <div className="w-14 h-14 rounded-xl bg-accent text-accent-foreground flex items-center justify-center shadow-md group-hover:shadow-xl group-hover:scale-110 transition-all duration-300">
                      {item.icon}
                    </div>
                    <div className="absolute inset-0 w-14 h-14 rounded-xl bg-accent blur-md opacity-30 group-hover:opacity-50 transition-opacity" />
                  </div>
                  <div className="flex-1">
                    <div className="flex items-start justify-between gap-4 mb-3">
                      <h4 className="text-foreground" style={{ fontSize: "1.2rem", fontWeight: 800, letterSpacing: "-0.01em" }}>
                        {item.title}
                      </h4>
                      <span className="px-3 py-1 rounded-full bg-accent/10 text-accent border border-accent/30 text-nowrap" style={{ fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.05em" }}>
                        {item.metrics}
                      </span>
                    </div>
                    <p className="text-muted-foreground leading-relaxed" style={{ fontSize: "0.95rem", lineHeight: 1.7 }}>
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-primary-foreground mb-6" style={{ fontSize: "clamp(2rem, 4vw, 3.5rem)", fontWeight: 900, letterSpacing: "-0.02em" }}>
              The Path Forward
            </h2>
            <div className="w-32 h-1.5 bg-gradient-to-r from-transparent via-accent to-transparent mx-auto rounded-full mb-8" />
            <p className="text-primary-foreground/70 max-w-3xl mx-auto leading-relaxed" style={{ fontSize: "1.2rem", lineHeight: 1.8 }}>
              Our strategic vision for establishing dominance in the premium mobility aggregation sector
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="group relative">
                ...
                <div className="relative h-full bg-primary-foreground/10 backdrop-blur-sm rounded-2xl p-8 border-2 border-accent/40 hover:border-accent/70 transition-all duration-300 group-hover:-translate-y-2 shadow-xl">
                  <div className="relative mb-6">
                  ...
                  <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-accent/20 border border-accent/40 mb-4">
                    <span className="text-accent uppercase tracking-wider" style={{ fontSize: "0.65rem", fontWeight: 700 }}>
                      {item.timeline}
                    </span>
                  </div>

                  <h4 className="text-primary-foreground mb-4" style={{ fontSize: "1.25rem", fontWeight: 800, letterSpacing: "-0.01em" }}>
                    {item.title}
                  </h4>
                  <p className="text-primary-foreground/70 leading-relaxed" style={{ fontSize: "0.95rem", lineHeight: 1.7 }}>
                    {item.desc}
                  </p>

                  <div className="mt-6 flex items-center gap-2 text-accent group-hover:gap-3 transition-all">
                    <span style={{ fontSize: "0.85rem", fontWeight: 600 }}>Learn more</span>
